          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-base">
                    ...
                    {language === "mr" ? "+९१-८८०५४६६७७७" : "+91-8805466777"}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-base break-all">
                    wayafalgrampanchayat@gmail.com
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/share/p/14U3M8mT1N8/"
                  className="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center hover:bg-blue-700 transition-colors"
                >
                  <FaFacebook className="text-xl" />
                </a>
                <a
                  href="http://www.youtube.com/@WAYFALGP"
                ...
                <a
                  href="https://www.instagram.com/wayfalgrampanchyat/"
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 mt-8">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="w-full aspect-[3/2] bg-gray-200 relative overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d32310.592547348242!2d75.24763198057789!3d17.16328933308213!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc6bf2b617915a9%3A0xaefa75005ee7dac6!2sWaifal%2C%20Maharashtra%2C%20India!5e0!3m2!1sen!2sus!4v1760783969360!5m2!1sen!2sus"
                width="1200"
                height="800"
                loading="lazy"
              ></iframe>
