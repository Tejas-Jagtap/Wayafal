      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-3xl sm:text-4xl font-bold text-government-orange mb-2">
                {language === "en" ? "2334" : "२३३४"}
              </h3>
              <p className="text-gray-700 text-sm sm:text-base">
                {t("intro.totalPopulation")}
              </p>
              <p className="text-xs text-gray-500 mt-2">
                {t("intro.males")}: {language === "en" ? "1193" : "११९३"} |{" "}
                {t("intro.females")}: {language === "en" ? "1141" : "११४१"}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span>{language === "en" ? "416414" : "४१६४१४"}</span>
                </div>
              </div>
            </div>
            {/* जमिनीचे वितरण */}
        ...
        <section className="bg-white rounded-lg shadow-lg p-6 sm:p-8 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Other sections like health, connectivity, water, electricity, other can remain unchanged */}
          </div>
        </section>
